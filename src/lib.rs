// src/lib.rs
/*
 * Core library for ContractManager
 */
...
#[derive(Debug)]
pub struct ContractManagerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContractManagerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContractManager processing");
    
    let mut processor = ContractManagerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContractManagerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContractManagerProcessor::new(false);
